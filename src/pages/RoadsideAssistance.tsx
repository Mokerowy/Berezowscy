// src/pages/RoadsideAssistance.tsx
    ...
    >
      ...
      <main className="relative z-10 w-full max-w-5xl space-y-10 my-12">
        ...
        <section className="bg-[#1c1c1c] bg-opacity-90 p-8 rounded-xl shadow-2xl backdrop-blur-sm">
          ...
          <a href="tel:123456789" className="block w-full text-center bg-[#ff6347] hover:bg-[#e6503c] text-white font-bold py-4 px-6 rounded-full text-xl transition-colors duration-300 ease-in-out mt-8">
